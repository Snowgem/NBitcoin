...
namespace NBitcoin.Altcoins
{
    ...
    public class SnowGem : NetworkSetBase
    {
        ...
        public override string CryptoCode => "XSG";

        private SnowGem()
        {

        }
        public class SnowGemConsensusFactory : ConsensusFactory
        {
            private SnowGemConsensusFactory()
            {
            }
            public static SnowGemConsensusFactory Instance { get; } = new SnowGemConsensusFactory();

            public override BlockHeader CreateBlockHeader()
            {
                return new SnowGemBlockHeader();
            }
            public override Block CreateBlock()
            {
                return new SnowGemBlock(new SnowGemBlockHeader());
            }
        }

#pragma warning disable CS0618 // Type or member is obsolete

        public class SnowGemBlock : Block
        {
            public SnowGemBlock(SnowGemBlockHeader header) : base(header)
            {
            ...
            {
                return SnowGemConsensusFactory.Instance;
            }
        }
        public class SnowGemBlockHeader : BlockHeader
        {
        ...
        {
            RegisterDefaultCookiePath("SnowGem");
            // Alternatively,
            /*
